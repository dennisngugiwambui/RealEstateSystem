            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h5 class="card-title"><i class="fas fa-plus-circle me-2"></i> Book Apartment</h5>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-success"><i class="fas fa-check me-2"></i> Book Now</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-header bg-info text-white">
                        <h5 class="card-title"><i class="fas fa-list-alt me-2"></i> Booked Apartments</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="card shadow mb-3" style="border-left: 5px solid #28a745;">
                            <div class="card-header bg-dark text-white">
                                <h5 class="card-title"><i class="fas fa-home me-2"></i> Apartment 1</h5>
                            </div>
                            <div class="card-body">
                                <p>Status: <span class="badge bg-success"><i class="fas fa-check me-2"></i> Active</span></p>
                        ...
                        <div class="card shadow mb-3" style="border-left: 5px solid #dc3545;">
                            <div class="card-header bg-dark text-white">
                                <h5 class="card-title"><i class="fas fa-home me-2"></i> Apartment 2</h5>
                            </div>
                            <div class="card-body">
                                <p>Status: <span class="badge bg-danger"><i class="fas fa-times me-2"></i> Inactive</span></p>
